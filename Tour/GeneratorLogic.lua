...
do
	...
	realDistanceWithHeight = function(a, b)
		...
		local dist = (dx * dx + dy * dy) / Harvest.GetGlobalMinDistanceBetweenPins()
		local correction = GeneratorLogic.mapCache.measurement.distanceCorrection
		dist = dist * 100 * correction * correction
